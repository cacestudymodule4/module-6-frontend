...
const AddStaff = () => {
    ...
    const addEmployee = async (values) => {
        try {
            ...
            if (response.status === 200 || response.status === 201) {
                ...
                setNewStaff({email: values.email, password: "123456789"});
                setShowModal(true);
            }
        } catch (error) {
    ...
    return (<>
        ...
        <div className="container my-5 rounded p-4" style={{maxWidth: '800px'}}>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                ...
                                <Field type="identification" name="identification"
            ...
            {showModal && (<div className="modal fade show d-block" tabIndex="-1" role="dialog"
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <p>Đó là mật khẩu mặc định của bạn. Nếu muốn bạn có thể đổi để thông tin bảo mật
                                hơn</p>
                        </div>
