    ...
    <div className="App">
      ...
      <Container bg="dark" className="py-5">
        <Row className='mb-4'>
          ...
          <Col md={4}>Với trên 15 năm kinh nghiệm trong lĩnh vực Quản lý tòa nhà, cho thuê căn hộ, văn phòng và môi giới các dự án Khu công nghiệp Hải Phòng</Col>
          <Col md={4}>
        ...
        <Row>
          <Col md={4}>
            <Card className="mb-4">
              <Card.Img variant="top" src="https://quanlychungcuhaiphong.vn/upload/services/thumb/15-9-2020/quan-ly-van-hanh-1-75-18.png" />
              <Card.Body>
                <Card.Title>Quản lý vận hành tòa nhà, chung cư và cụm chung cư</Card.Title>
                <Card.Text>
                  Với trên 14 năm kinh nghiệm trong công tác quản lý vận hành khai thác các Tòa nhà tại Hải Phòng. Công ty Lexico đã quản lý, vận hành nhà chung cư, tòa nhà căn hộ như là đơn vị Quản lý vận[...]
                </Card.Text>
          ...
          <Col md={4}>
            <Card className="mb-4">
              <Card.Img variant="top" src="https://quanlychungcuhaiphong.vn/upload/services/thumb/2-4-2022/duog6717-99.jpg" />
              <Card.Body>
                <Card.Title>TƯ VẤN QUẢN LÝ VẬN HÀNH, SỬ DỤNG TÒA NHÀ CHUNG CƯ</Card.Title>
                <Card.Text>
                  Đơn vị chúng tôi nhận và thực hiện các công việc Quản lý vận hành khu chung cư cao tầng sau
                </Card.Text>
                <Button variant="success">Learn More</Button>
              </Card.Body>
            </Card>
          ...
          <Col md={4}>
            <Card className="mb-4">
              <Card.Img variant="top" src="https://quanlychungcuhaiphong.vn/upload/services/thumb/20-7-2021/nho-2---copy-17.jpg" />
              <Card.Body>
                <Card.Title>Dịch vụ kỹ thuật</Card.Title>
                <Card.Text>
                  Dịch vụ kỹ thuật tòa nhà chung cư văn phòng Công ty TNHH Thương Mại và Dịch Vụ Lê Xi cung cấp được quý khách đánh giá cao về chất lượng và sự tận tình. Được thành lập theo giấy phép đăng ký[...]
                </Card.Text>
                <Button variant="success">Learn More</Button>
              </Card.Body>
            </Card>
        ...
        <Container className="contact-section">
          <Row className="justify-content-center contact-content">
            <Col md={5} className="mb-5 contact-box">
              ...
              <p><FaEnvelope /> thuydung.lexico@gmail.com</p>
            </Col>
            <Col md={5}>
        ...
        <Carousel.Item style={{ height: 500 }}>
          ...
          >
            <Card style={{ width: '18rem' }}>
              <Card.Img variant="top" src="https://quanlychungcuhaiphong.vn/upload/services/thumb/15-9-2020/quan-ly-van-hanh-1-75-18.png" />
              <Card.Body>
                <Card.Title>Tòa nhà SHP Plaza</Card.Title>
              </Card.Body>
            </Card>
            <Card style={{ width: '18rem' }}>
              <Card.Img variant="top" src="https://quanlychungcuhaiphong.vn/upload/services/thumb/2-4-2022/duog6717-99.jpg" />
              <Card.Body>
                <Card.Title>Chung cư Diamond Crown Plaza</Card.Title>
              </Card.Body>
            </Card>
            <Card style={{ width: '18rem' }}>
              <Card.Img variant="top" src="https://quanlychungcuhaiphong.vn/upload/services/thumb/20-7-2021/nho-2---copy-17.jpg" />
              <Card.Body>
                <Card.Title>Chung cư HEZA</Card.Title>
              </Card.Body>
            </Card>
          </Stack>
        </Carousel.Item>

        {/* Thêm các Carousel.Item khác tương tự nếu cần */}
      </Carousel>
